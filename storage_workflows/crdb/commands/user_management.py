...
def create_user_if_not_exist(cluster_name, deployment_env, region, aws_account, cluster_name, role_name):
    storage_metadata = StorageMetadata()
    existing_user = storage_metadata.get_user(cluster_name, region, aws_account, cluster_name, role_name, deployment_env)
    if existing_user is None:
        ...
        storage_metadata.insert_user(cluster_name=cluster_name, deployment_env=deployment_env, region=region,
                                     aws_account=aws_account, database_name=cluster_name, role_name=role_name,
